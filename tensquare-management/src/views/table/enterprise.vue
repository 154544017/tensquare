...
<el-input v-model="searchMap.name" placeholder="企业名称"></el-input></el-form-item>
  ...
  <el-table
    ...
    style="width: 100%">
          ...
          <el-table-column align="center" prop="summary" label="企业简介" width="170" :show-overflow-tooltip='true'></el-table-column>
          ...
          <el-table-column align="center" label="LOGO" width="80">
            <template slot-scope="scope">
              　<img :src="scope.row.logo" width="80" height="80" class="head_pic"/>
            </template>
          </el-table-column>
