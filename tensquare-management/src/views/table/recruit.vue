...
<el-input v-model="searchMap.mycondition" placeholder="经验要求"></el-input></el-form-item>
...
<el-input v-model="searchMap.content2" placeholder="职位要求"></el-input></el-form-item>
  ...
  <el-table
    ...
    style="width: 100%">
          ...
          <el-table-column prop="mycondition" label="经验要求" width="80"></el-table-column>
          ...
          <el-table-column prop="content1" label="职位描述" width="80" :show-overflow-tooltip='true'></el-table-column>
          <el-table-column prop="content2" label="职位要求" width="80" :show-overflow-tooltip='true'></el-table-column>
  ...
  <el-dialog title="编辑" :visible.sync="dialogFormVisible">
    <el-form label-width="80px">
        ...
        <el-form-item label="经验要求"><el-input v-model="pojo.mycondition"></el-input></el-form-item>
